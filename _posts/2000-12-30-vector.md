...
<a title="By Darth Stabro at en.wikipedia [CC-BY-SA-3.0 (http://creativecommons.org/licenses/by-sa/3.0/)], from Wikimedia Commons" href="http://commons.wikimedia.org/wiki/File%3AVectorBitmapExample.svg"><img width="512" alt="VectorBitmapExample" src="{{BASE_PATH}}{{ASSET_PATH}}/images/VectorBitmapExample.svg"/></a>
...
<br>
<br>
<img width="512px" src="{{BASE_PATH}}{{ASSET_PATH}}/images/Simple_vector_map.svg"/> <br>

<a title="By Wegmann (Own work) [CC BY-SA 3.0 (http://creativecommons.org/licenses/by-sa/3.0) or GFDL (http://www.gnu.org/copyleft/fdl.html)], via Wikimedia Commons" target="_blank" href="http://commons.wikimedia.org/wiki/File%3ARaster_vector_tikz.png"><img width="450" alt="Raster vector tikz" src="{{BASE_PATH}}{{ASSET_PATH}}/images/1024px-Raster_vector_tikz.png"/></a>
