...
<ol>
<li>Open QGIS and import vector data. Choose one of the following:
...
<br><br>
<ol>
<li>Click on the <strong>iRods</strong> tool icon and enter your <strong>iPlant username and password</strong>:<br><br><img data-featherlight="{{BASE_PATH}}{{ASSET_PATH}}/images/vector-irods.png" src="{{BASE_PATH}}{{ASSET_PATH}}/images/vector-irods.png" alt="Spatial Data Bootcamp: QGIS - iRods"/><br><br></li>
<li>Navigate to <code>/iplant/home/shared/aegis/Spatial-bootcamp/basics/vector</code></li> 
<li>Within the <code>/vector/</code> directory, click (to highlight) <strong>arizona_counties.shp</strong>, then <strong>import</strong>.<br><br><img alt="Spatial Data Bootcamp: QGIS - import vector data through iRods"/></li>
<br><br>
</ol>
</li>

<li>Download zip:<br>&nbsp;&nbsp;&nbsp;<a href="http://de.iplantcollaborative.org/dl/d/31085E1F-F3E3-4E30-8848-FC14011E6015/arizona_counties.zip">arizona_counties.zip</a><br><br>
<ol>
<li> For non-iRods access, download, unpack ,and import the Arizona Counties shapefile by clicking the <strong>Add Vector Layer</strong> <img src="{{BASE_PATH}}{{ASSET_PATH}}/images/add-vector.png"/> button in the Toolbar, or by navigating through <em>Menu Bar > Add Layer > Add Vector Layer.</em><br><br>Subsequent exercises will refer to adding data through the buttons in the Toolbar.<br><br></li>
...
<li>Your map should now look similar to the one below; categorized by county name (NAME_2) with random colors.<br><br><img data-featherlight="{{BASE_PATH}}{{ASSET_PATH}}/images/qgis-intro-9.png" src="{{BASE_PATH}}{{ASSET_PATH}}/images/qgis-intro-9.png" alt="Spatial Data Bootcamp: QGIS - symbolized by county name"/><br><br>Close your worspace- this will prompt to save your existing workspace; save if you must, else No. Move on to the next lesson.
</li>
</ol>
</ol>
