...
iPlant Data Store: <br>&nbsp;&nbsp;&nbsp;``/Community Data/aegis/Spatial-bootcamp/basics/raster``

- [Landsat7 ETM 2015-05-10](link-here)
...
<ol>
<li>Be sure you have already downloaded the <a href="#">raster data set</a>.</li>
<li>Open QGIS if you do not already have it open and import the Landsat7 imagery with <strong>Add Raster Layer</strong>. Your workspace should look like the image below:<br><br><img data-featherlight="{{BASE_PATH}}{{ASSET_PATH}}/images/qgis-intro-14.png" src="{{BASE_PATH}}{{ASSET_PATH}}/images/qgis-intro-14.png" alt="Spatial Data Bootcamp: QGIS - open raster layer"/>
</li>
</ol>
</li>
